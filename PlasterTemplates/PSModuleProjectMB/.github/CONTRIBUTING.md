# How to contribute
Contributions to <%= $PLASTER_PARAM_GitHubRepo %> are highly encouraged and desired. Below are some guidelines that will help make the process as smooth as possible.
...
I want to know what you think is missing from <%= $PLASTER_PARAM_GitHubRepo %> and how it can be made better.
